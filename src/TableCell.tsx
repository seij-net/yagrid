...
export const TableCell: React.FC<TableCellProps<any>> = ({ editing, render, editor, item, itemPropertyName, onEditItemChange }) => {
    const Component = editing && editor
        ? editor(item, onEditItemChange)
        : render(item[itemPropertyName])
