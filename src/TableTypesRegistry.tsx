...
const NumberFormatDecimal = new Intl.NumberFormat(undefined, { minimumFractionDigits: 2,maximumFractionDigits: 2, style:"decimal" })
const NumberFormatMonetaryAmountInt = new Intl.NumberFormat(undefined, { minimumFractionDigits: 0, style:"currency", currencyDisplay:"narrowSymbol", currency:"EUR" })
const NumberFormatMonetaryAmountDecimal = new Intl.NumberFormat(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2, style:"currency",currencyDisplay:"narrowSymbol", currency:"EUR" })
const NumberFormatPercent = new Intl.NumberFormat(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2, style:"percent" })

const renderToReactElement = (formatter: (curatedData: any) => string) => (data: any) => isNil(data) ? "" : formatter(data)
...
const MONETARY_AMOUNT_DECIMAL_RENDERER =  renderToReactElement((data:any) => NumberFormatMonetaryAmountDecimal.format(data))
